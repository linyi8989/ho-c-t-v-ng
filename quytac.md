...
- Smart Import Mover mặc định chọn `Stali · GPT 5.6 Sol` khi provider này đã được cấu hình và hỗ trợ Vision; nếu Sol không khả dụng thì UI phải fallback về lựa chọn khả dụng an toàn thay vì gửi request chắc chắn thất bại. Giáo viên vẫn được đổi provider thủ công cho từng lượt phân tích.
