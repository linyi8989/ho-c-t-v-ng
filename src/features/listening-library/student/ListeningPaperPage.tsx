...
interface Props { moduleId: ListeningModuleId; paperId: ListeningPaperId; onBack: () => void; onNavigate: (href: string) => void }

export default function ListeningPaperPage({ moduleId, paperId, onBack, onNavigate }: Props) {
  ...
  const total = manifest.totalQuestionCount ?? (typeof manifest.questionsPerPart === 'number'
