...
function PartView({ moduleId, paperId, part, answers, onAnswer, standaloneWriting = false, starterListening = false, flyerListening = false, ketListening = false, starterReadingWriting = false, flyerReadingWriting = false, ketReadingWriting = false }: { moduleId: Exclude<ExamModuleId, 'mover'>; paperId: ExamPaperId; part: ExamPartContent; answers: ExamAnswers; onAnswer: (questionId: string, value: ExamAnswerValue) => void; standaloneWriting?: boolean; starterListening?: boolean; flyerListening?: boolean; ketListening?: boolean; starterReadingWriting?: boolean; flyerReadingWriting?: boolean; ketReadingWriting?: boolean }) {
