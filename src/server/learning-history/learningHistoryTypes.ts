export type LearningSourceType = 'vocabulary' | 'grammar' | 'listening' | 'reading_writing' | 'exam';
...
export interface LearningAttemptWrite {
  ...
  lessonType: 'vocab_set' | 'grammar_set' | 'listening_set' | 'mover_reading_set' | 'exam_set';
  gameId: string;
